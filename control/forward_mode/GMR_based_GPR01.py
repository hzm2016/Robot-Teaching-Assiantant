...
def word_process_main(
    ...
    x_list_1 = np.array([0.31, 0.3, 0.35])
    y_list_1 = np.array([-0.15, -0.03, 0.16])
    ...
    # word ren stroke : 1
    # X_obs = np.array([0.1, 1.40])[:, None]
    # x_list_1 = np.array([0.30, 0.40])
    # y_list_1 = np.array([-0.02, 0.12])
...
if __name__ == '__main__':
    ...
    # kernel_list = [GPy.kern.Matern52(1, variance=2., lengthscale=3.) for i in range(gmr_model.nb_states)]
    #
