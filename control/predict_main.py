...
if __name__ == "__main__":
	...
	likelihoods_list = [GPy.likelihoods.Gaussian(name="Gaussian_noise_%s" % j, variance=0.001) for j in
						range(output_dim)]
	kernel_list = [GPy.kern.RBF(1, variance=0.001, lengthscale=10) for i in range(gmr_model.nb_states)]
